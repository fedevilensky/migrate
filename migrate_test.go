...
import (
	...
	dStub "github.com/fedevilensky/migrate/v4/database/stub"
	"github.com/fedevilensky/migrate/v4/source"
	sStub "github.com/fedevilensky/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/fedevilensky/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/fedevilensky/migrate/v4/source/stub"`
